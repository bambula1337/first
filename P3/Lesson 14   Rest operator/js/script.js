...
//Creating the class Card of food
class Card {
  constructor(name, description, price, imgurl, alt, ...classes) {
    this.name = name;
  ...
  create() {
    ...
    this.box.classList.add("tabcontent");
    ...
    if (this.classes.length == 0) {
      this.box.firstChild.classList.add('menu__item');
    } else {
      this.classes.forEach(className => this.box.firstElementChild.classList.add(className));
    }
  }
...
const wrapper = document.querySelector("#cardsbox");
