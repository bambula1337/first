...
const connectmodal = function(modal,trigger,close){
  const modalSOR = function(display = "none", overflow = "visible"){
    modal.style.display = display;
    document.body.style.overflow = overflow; 
  };
  trigger.forEach((e) =>{
    e.addEventListener("click", () =>{
      modalSOR("block", "hidden");
    });
  });
...
connectmodal(modalwindow, modalbtn, modalclose);
